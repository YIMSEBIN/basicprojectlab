...
class ViewFeelingDiary extends StatefulWidget {
  ...
  const ViewFeelingDiary({Key? key, required this.feeling}): super(key: key);

  @override
  _ViewFeelingDiaryState createState() => _ViewFeelingDiaryState();
}

class _ViewFeelingDiaryState extends State<ViewFeelingDiary> with TickerProviderStateMixin {
